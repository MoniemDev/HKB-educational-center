...
import { ArrowLeft, Stethoscope, BookOpen, Users, Clock, ArrowRight } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <div className="flex items-center justify-center gap-3 mb-6">
              <Stethoscope className="h-8 w-8 md:h-10 md:w-10 text-primary" />
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              تعلم الطب البشري بأسلوب شامل ومتكامل مع أفضل الأساتذة والمحتوى التعليمي عالي الجودة
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <div className="text-2xl md:text-3xl font-bold text-primary">27+</div>
            ...
            <div className="text-center">
              <div className="flex items-center justify-center w-12 h-12 md:w-16 md:h-16 rounded-full bg-secondary/10 mx-auto mb-3">
                <Stethoscope className="h-6 w-6 md:h-8 md:w-8 text-secondary" />
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              المنهج الدراسي للطب البشري
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              منهج شامل يغطي جميع التخصصات الطبية الأساسية والمتقدمة
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {Object.entries(medicineFields).map(([category, courses], index) => (
      ...
      <section className="py-16 bg-gradient-to-l from-primary/5 to-secondary/5">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">
            ابدأ رحلتك في تعلم الطب البشري
          </h2>
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            انضم إلى آلاف الطلاب الذين يتعلمون الطب بأسلوب احترافي ومبسط
          </p>
          <Button
            size="lg"
            className="gradient-primary text-white"
